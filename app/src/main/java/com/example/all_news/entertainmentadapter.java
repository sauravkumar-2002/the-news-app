...
public class entertainmentadapter extends RecyclerView.Adapter<entertainmentadapter.viewholder> {
    ...
    public entertainmentadapter(List<modelarticles> listnew, Context context) {
        this.listnew = listnew;
        this.context = context;
    }
    @NonNull
    @Override
    public entertainmentadapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.singlerow_general,parent,false);
        return new entertainmentadapter.viewholder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull entertainmentadapter.viewholder holder, int position) {
